<%@ Page Language="C#" Title="Type Wise Report" MasterPageFile="../master.Master"  AutoEventWireup="true" CodeBehind="TypeWiseReport.aspx.cs" Inherits="Diagnostic_Application.View.TypeWiseReport" %>


<asp:Content ID="contentTypeWiseReport" ContentPlaceHolderID="MainContent" runat="server">

    <form id="form1" class="form-horizontal" runat="server">
        <h3 class="title">Type Wise Report</h3>
                ...
                <asp:GridView 
                    ...
                    ShowFooter="True" OnRowDataBound="TypeWiseReportGridView_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Test Type Name" DataField="TypeName" />
                            <asp:BoundField HeaderText="Total no of Test" DataField="TotalCount" />
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:Button ID="PdfButton" runat="server" cssClass="btn btn-primary btn-custom right" Text="PDF" OnClick="PdfButton_Click" />
